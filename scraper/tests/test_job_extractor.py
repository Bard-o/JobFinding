...
class TestNormalizeUrl:
    ...
    def test_normalize_empleos_to_jobs(self) -> None:
        ...
        assert (
            normalize_url(url)
            == "https://www.getonboard.com/jobs/programming/react-dev"
        )
    ...
    def test_normalize_preserves_query_and_fragment(self) -> None:
        ...
        assert (
            normalize_url(url) == "https://www.getonboard.com/jobs/dev?ref=home#apply"
        )
...
class TestExtractJobCompleteFixture:
    ...
    def test_extracts_title(self, complete_html: str) -> None:
        ...
        job = extract_job(
            complete_html,
            "https://www.getonboard.com/jobs/programming/senior-react-developer",
        )
    ...
    def test_normalizes_empleos_url(self, complete_html: str) -> None:
        ...
        job = extract_job(
            complete_html,
            "https://www.getonboard.com/empleos/programming/senior-react-developer",
        )
...
class TestExtractJobMinimalFixture:
    ...
    def test_extracts_title_from_h1(self, minimal_html: str) -> None:
        ...
        job = extract_job(
            minimal_html, "https://www.getonboard.com/jobs/programming/python-dev"
        )
...
class TestExtractJobAllFieldsFixture:
    ...
    def test_extracts_title_with_lead(self, all_fields_html: str) -> None:
        ...
        job = extract_job(
            all_fields_html,
            "https://www.getonboard.com/jobs/programming/lead-full-stack-engineer",
        )
